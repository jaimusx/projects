    ...
    <div class="navbar-header">
		...
		<div class="collapse navbar-collapse" id="myNavbar">
			<ul class="nav navbar-nav">
				...
				<li><a href="about_us.php"><span class="glyphicon glyphicon-exclamation-sign"></span> AboutUs</a></li>
				<li><a href="contact_us.php"><span class="glyphicon glyphicon-earphone"></span> ContactUs</a></li>
			</ul>
			...
			<?php
				if(isset($_SESSION['username'])) {
					...
					echo '<li><a href="student_page.php"><span class="glyphicon glyphicon-info-sign"></span> Student Page</a></li>';
				} else {
